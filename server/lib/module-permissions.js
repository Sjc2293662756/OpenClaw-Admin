...
export const MODULE_PERMISSION_CATALOG = Object.freeze([
  ...
  { moduleKey: 'alerts.notifications', name: '告警通知/弹窗', group: '业务管理', risk: 'medium', defaultRoles: ALL, dependencies: [], routes: [], rest: ['/api/alerts/notifications*', 'GET /api/alerts/changes', 'GET /api/alerts/preferences', 'PUT /api/alerts/preferences'], sse: ['alert', 'alertStreamState', 'alertNotificationStateChanged'], rpc: [], dataScope: '系统级脱敏告警摘要；通知状态和偏好仅当前账户' },
