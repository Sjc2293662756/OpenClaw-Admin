...
export default {
  ...
  pages: {
    ...
    skills: {
      title: 'Skills',
      readOnlyInfo: 'This is a safe read-only view showing only Skill name, description, version, and availability.',
    ...
    channels: {
      ...
      pluginStatus: {
        installed: 'Component ready',
        notInstalled: 'Component unavailable',
        assumedInstalled: 'Component ready',
        unknown: 'Component status unknown',
      },
      configured: 'Configured',
      notConfigured: 'Not configured',
      safeRuntimeStatus: 'Safe runtime status',
      componentHint: {
        missing: 'The {channel} component was not detected in this image. This page never downloads or installs components; check the ISO contents and service status.',
        unknown: 'The {channel} component status cannot be confirmed. Configuration can still be saved, but it only takes effect after the image component is ready.',
      },
      configurationCardTitle: 'Channel configuration',
      configurationHint: 'Create a disabled {channel} draft, fill in identity and credential fields, then enable and apply it after verification.',
      startConfiguration: 'Configure',
      configDraftCreated: '{channel} draft created and left disabled',
      ...
      placeholders: {
        ...
        allowFrom: 'One external user ID per line, or comma-separated',
        secret: 'Enter new value (leave blank to keep)',
      },
      dmPolicies: {
        pairing: 'Require pairing approval (recommended)',
        allowlist: 'Allowlisted users only',
        open: 'Allow DMs within app visibility',
        disabled: 'Reject all DM users',
      },
      ...
      feishuOnboarding: {
        ...
        openScanPage: 'Open the scan page in a new window',
        expiresAt: 'The QR code expires at {time}',
        configured: 'Onboarding completed and the Feishu configuration was securely written to Gateway. Use “Save & apply” at the top to reload the channel component.',
        expired: 'The QR code expired. Generate a new one.',
        failed: 'Onboarding did not complete. Generate a new QR code; credentials were not displayed or recorded.',
        startFailed: 'The Feishu onboarding QR code could not be generated.',
        statusFailed: 'The Feishu onboarding status could not be loaded.',
        cancelled: 'This Feishu onboarding session was cancelled.',
        cancelFailed: 'The Feishu onboarding session could not be cancelled.',
        status: {
          starting: 'Generating QR code…',
          waiting_for_scan: 'Scan with a Feishu administrator account and confirm onboarding in Feishu.',
          configuring: 'Scanned. Writing the configuration to Gateway securely…',
          configured: 'Onboarding completed and the Feishu configuration was written to Gateway.',
          failed: 'Onboarding failed. Generate a new QR code.',
          expired: 'The QR code expired. Generate a new one.',
          cancelled: 'This onboarding session was cancelled.',
        },
      },
      personalWechat: {
        ...
        plugin: {
          ...
          notInstalledHint: 'The Personal WeChat plugin was not detected. This page never installs plugins or runs npm/npx. Operations must install it through a controlled change and verify every existing channel first.',
          unavailableHint: 'The Personal WeChat plugin is installed but cannot safely provide QR onboarding or account management. Check Gateway health, compatibility, and plugin runtime status.',
        },
        empty: {
          ready: 'The plugin is ready and currently has no accounts. Add an account by QR; the plugin will not be reinstalled.',
          unavailable: 'No Personal WeChat accounts are available. Accounts can be added here after the plugin is ready.',
        },
        labels: {
          nickname: 'WeChat nickname',
          identifier: 'WeChat identifier',
          note: 'Note',
        ...
        onboarding: {
          ...
          expiresAt: 'The QR code expires at {time}',
          unsafeQr: 'The QR source failed the security check and was blocked. Cancel this session and check service health.',
          cancelSession: 'Cancel onboarding',
          tryAgain: 'Generate another',
          status: {
            starting: 'Creating the onboarding session…',
            waiting_for_scan: 'Waiting for WeChat scan. Scan with the Personal WeChat account to connect.',
            scanned: 'Scanned. Waiting for WeChat confirmation and account login.',
            verification_required: 'WeChat requires an additional verification code. Enter the code shown or delivered by WeChat.',
            success: 'QR login completed and the Personal WeChat account was added.',
            expired: 'The QR code expired. Generate a new one.',
            failed: 'QR login failed. Review the status and generate a new QR code.',
            cancelled: 'This onboarding session was cancelled.',
          },
        },
        verification: {
          label: 'WeChat verification code',
          placeholder: 'Enter verification code',
          submit: 'Submit code',
          required: 'Enter the WeChat verification code',
        },
        messages: {
          loadFailed: 'Failed to load Personal WeChat status',
          startFailed: 'Failed to generate the Personal WeChat QR code',
          statusFailed: 'Failed to load Personal WeChat onboarding status',
          verifyFailed: 'Failed to submit the WeChat verification code',
          cancelFailed: 'Failed to cancel onboarding',
          cancelled: 'Onboarding session cancelled',
          added: 'Personal WeChat account added',
          expired: 'The Personal WeChat QR code expired',
          failed: 'Personal WeChat QR login failed',
    ...
    sessions: {
      ...
      list: {
        ...
        badges: {
          active24h: 'Active (24h)',
          inactive: 'Inactive',
          pendingDelete: 'Pending deletion (7 days)',
          longTerm: 'Long-term retention',
          attachmentsProtected: '{count} protected attachments',
        },
        retention: {
          cancelPending: 'Cancel deletion',
          confirmCancelPending: 'Cancel this pending-deletion mark? The same activity snapshot will not be marked again until the session has new activity.',
          cancelSuccess: 'Pending deletion cancelled',
          enableLongTerm: 'Retain long term',
          disableLongTerm: 'Use standard retention',
          confirmEnableLongTerm: 'Retain this session indefinitely? Automatic retention jobs will never process it.',
          confirmDisableLongTerm: 'Restore the standard 180-day retention policy?',
          enableSuccess: 'Session set to long-term retention',
          disableSuccess: 'Session restored to standard retention',
          updateFailed: 'Failed to update session retention',
        },
    ...
    system: {
      ...
      network: 'Network',
      storageWatermark: {
        title: 'GAIOP managed storage watermarks',
        loadFailed: 'Managed storage watermarks are unavailable',
        lastAlert: 'Latest alert: {time}',
        states: {
          normal: 'Normal',
          warning: 'Warning',
        ...
        roots: {
          ...
          admin_upgrade_staging: 'Upgrade staging',
          gateway_state: 'Gateway state',
          raw_syslog: 'Raw Syslog',
          caddy_access_logs: 'Caddy access logs',
        },
      },
    },
    terminal: {
    ...
    gaiop: {
      accessDenied: {
        title: 'Access Denied', module: 'Module: {module}', role: 'Current role: {role}',
        description: 'Your account does not have access to this feature. Please contact an administrator if you need it.', back: 'Go back', dashboard: 'Go to Dashboard',
      ...
      users: {
        ...
        username: 'Username', description: 'Description', role: 'Role', status: 'Status', updatedAt: 'Updated', actions: 'Actions', active: 'Active', inactive: 'Inactive', basic: 'Basic user', auditor: 'Audit user', standard: 'Standard user', admin: 'Administrator', initialAdmin: 'Initial administrator',
        editAction: 'Edit', resetAction: 'Reset', deleteAction: 'Delete', changePassword: 'Change password', back: 'Back', save: 'Save', submit: 'Submit', cancel: 'Cancel', confirm: 'Confirm',
        readOnly: 'You are using an audit account. You can view account information, but cannot create, edit, reset passwords, enable or disable, or delete accounts.', adminOnly: 'Only administrators can perform this action', createAdminOnly: 'Only administrators can add users.',
        loadFailed: 'Failed to load users', createFailed: 'Failed to add user', createSuccess: 'User added', updateFailed: 'Failed to save user', updateSuccess: 'User updated', passwordFailed: 'Failed to change password', passwordSuccess: 'Password changed. Please sign in again with the new password.',
        currentPassword: 'Current password', newPassword: 'New password', confirmPassword: 'Confirm password', passwordPlaceholder: 'Enter password', confirmPasswordPlaceholder: 'Re-enter password', forcedChange: 'An administrator reset your password. Other features are unavailable until you change it and sign in again.',
      ...
      alerts: {
        title: 'Alert Records', refresh: 'Refresh', export: 'Export Excel', details: 'Details', empty: 'No alerts match the current filters',
        ...
        exportEmpty: 'There are no alerts on the current page to export', exportSuccess: 'Exported {count} alerts from the current page', exportFailed: 'Failed to export Excel', focusNotFound: 'This alert was not found. It may have expired or is not currently queryable.', focusUnavailable: 'This alert detail cannot be located right now. The current page remains available.', resetFiltersAndLocate: 'Reset filters and locate', analysisNumberUnavailable: 'No authoritative alert number is recorded, so an analysis instruction cannot be generated.',
      },
      alertCenter: {
        title: 'Alert Notifications', open: 'Open alert notifications', empty: 'No alert notifications', all: 'All', unread: 'Unread', counts: '{total} total, {unread} unread', loadMore: 'Load more', operationFailed: 'Alert notification operation failed. Try again later.', offlineSummaryTitle: 'Alerts while offline', offlineSummaryContent: '{total} total: {minor} minor, {major} major, {critical} critical', viewOfflineSummary: 'View alert notifications', offlineSummaryRange: 'Showing alert notifications from this offline period', showAll: 'Show all', markAllRead: 'Mark all read', markFilteredRead: 'Mark filtered read', clear: 'Clear all', clearFiltered: 'Clear filtered', remove: 'Remove', severityFilter: 'Filter by alert severity',
      ...
      audit: {
        ...
        time: 'Time', result: 'Result', user: 'User', role: 'Role', category: 'Category', actionDetail: 'Action / detail', target: 'Target', source: 'Source', errorCode: 'Error code',
        notRecorded: 'Not recorded', exportEmpty: 'There are no audit logs to export for the current filters', exportFailed: 'Failed to export audit logs', exportSuccess: 'Exported {count} audit logs',
        roles: { basic: 'Basic user', auditor: 'Audit user', standard: 'Standard user', admin: 'Administrator', system: 'System' },
        categories: { authentication: 'Authentication', authorization: 'Authorization', resource_access: 'Resource access', operation: 'Business operation', system: 'System event' },
        sources: { auth: 'Authentication', rest: 'REST API', rpc: 'Gateway RPC', system: 'System' }, results: { success: 'Success', failed: 'Failed', denied: 'Denied' },
      },
    },
  },
} as const
